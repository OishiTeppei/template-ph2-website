        ...
        <section class="p-quiz-box js-quiz" data-quiz="<?= $i ?>">
          <div class="p-quiz-box__question">
            <h2 class="p-quiz-box__question__title">
              ...
              <span class="p-quiz-box__question__title__text"><?= htmlspecialchars($question["content"], ENT_QUOTES, 'UTF-8'); ?></span>
            </h2>
            <?php if ($question["image"]) { ?>
              <figure class="p-quiz-box__question__image">
                <img src="../assets/img/quiz/<?= htmlspecialchars($question["image"], ENT_QUOTES, 'UTF-8'); ?>" alt="Image for Question <?= $i + 1 ?>">
              </figure>
            <?php } ?>
          </div>
          ...
          <?php if (!empty($question["supplement"])) { ?>
            <cite class="p-quiz-box__note">
              <i class="u-icon__note"></i><?= htmlspecialchars($question["supplement"], ENT_QUOTES, 'UTF-8') ?>
            </cite>
          <?php } ?>
        </section>
      <?php } ?>
